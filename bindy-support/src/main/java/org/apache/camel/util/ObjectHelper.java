...
public final class ObjectHelper {
     ...
     */
    public static boolean equalIgnoreCase(final Object a, final Object b) {
     ...
     * nulls
     */
    public static boolean equalByteArray(final byte[] a, final byte[] b) {
     ...
     */
    public static boolean isEqualToAny(final Object object, final Object... values) {
     ...
     * @throws IllegalArgumentException is thrown if assertion fails
     */
    public static <T> T notNull(final T value, final String name, final Object on) {
        if (on == null) {
            notNull(value, name);
        } else if (value == null) {
     ...
     * @return an Optional
     */
    public static Optional<Object> firstNotNull(final Object... values) {
        for (final Object value : values) {
            if (value != null) {
     ...
     */
    public static <T> T supplyIfEmpty(final T value, final Supplier<T> supplier) {
     ...
     */
    public static <T> void ifNotEmpty(final T value, final Consumer<T> consumer) {
        if (isNotEmpty(value)) {
     ...
     */
    public static boolean matches(final List<?> list) {
        if (!list.isEmpty()) {
     ...
     */
    public static boolean getSystemProperty(final String name, final Boolean defaultValue) {
        final String result = getSystemProperty(name, defaultValue.toString());
     ...
     */
    public static String classCanonicalName(final Object value) {
        if (value != null) {
     ...
     * @return the class or <tt>null</tt> if it could not be loaded
     */
    public static Class<?> loadClass(String name, final ClassLoader loader, final boolean needToWarn) {
     ...
     */
    public static boolean isOverridingMethod(final Method source, final Method target) {
     ...
     * @return <tt>true</tt> if it override, <tt>false</tt> otherwise
     */
    public static boolean isOverridingMethod(final Method source, final Method target, final boolean exact) {
     ...
     * @return <tt>true</tt> if it override, <tt>false</tt> otherwise
     */
    public static boolean isOverridingMethod(final Class<?> inheritingClass, final Method source, final Method target, final boolean exact) {
        ...
        if (exact) {
            ...
            if (!source.getReturnType().isAssignableFrom(target.getReturnType())) {
                final boolean b1 = source.isBridge();
                final boolean b2 = target.isBridge();
        ...
        final Class<?>[] sourceTypes = source.getParameterTypes();
        final Class<?>[] targetTypes = target.getParameterTypes();
    ...
    public static List<Method> findMethodsWithAnnotation(Class<?> type,
                                                         final Class<? extends Annotation> annotationType,
                                                         final boolean checkMetaAnnotations) {
        final List<Method> answer = new ArrayList<>();
        do {
     ...
     */
    public static boolean hasAnnotation(final AnnotatedElement elem, final Class<? extends Annotation> annotationType,
                                        final boolean checkMetaAnnotations) {
        if (elem.isAnnotationPresent(annotationType)) {
            return true;
        }
        if (checkMetaAnnotations) {
            for (final Annotation a : elem.getAnnotations()) {
                for (final Annotation meta : a.annotationType().getAnnotations()) {
     ...
     */
    public static String asString(final Object[] objects) {
        if (objects == null) {
            return "null";
        } else {
    ...
    public static int arrayLength(final Object[] pojo) {
        return pojo.length;
    }
     ...
     * {@link Integer}
     */
    public static Class<?> convertPrimitiveTypeToWrapperType(final Class<?> type) {
        Class<?> rc = type;
        if (type.isPrimitive()) {
            if (type == int.class) {
                rc = Integer.class;
     ...
     */
    public static boolean hasAnnotation(final Annotation[] annotations, final Class<?> type) {
     ...
     */
    public static <A extends java.lang.annotation.Annotation> A getAnnotation(final Object instance, final Class<A> type) {
    ...
    public static <T> T cast(final Class<T> toType, final Object value) {
        if (toType == boolean.class) {
            return (T) cast(Boolean.class, value);
        } else if (toType.isPrimitive()) {
            final Class<?> newType = convertPrimitiveTypeToWrapperType(toType);
            if (newType != toType) {
     ...
     */
    public static boolean hasDefaultPublicNoArgConstructor(final Class<?> type) {
        // getConstructors() returns only public constructors
        for (final Constructor<?> ctr : type.getConstructors()) {
     ...
     */
    public static Object type(final Object bean) {
     ...
     */
    public static boolean evaluateValuePredicate(final Object value) {
        if (value instanceof Boolean) {
            return (Boolean) value;
        } else if (value instanceof String) {
     ...
     * @return the Iterable
     */
    public static Iterable<Throwable> createExceptionIterable(final Throwable exception) {
     ...
     * @return the Iterator
     */
    public static Iterator<Throwable> createExceptionIterator(final Throwable exception) {
     ...
     */
    public static <T> T getException(final Class<T> type, final Throwable exception) {
        if (exception == null) {
            return null;
        }

        //check the suppressed exception first
        for (final Throwable throwable : exception.getSuppressed()) {
    ...
    public static String getIdentityHashCode(final Object object) {
     ...
     */
    public static String lookupConstantFieldValue(final Class<?> clazz, String name) {
        if (clazz == null) {
            return null;
        }
     ...
     * @deprecated Use {@link org.apache.camel.api.RuntimeCamelException#wrapRuntimeCamelException} instead
     */
    @Deprecated
    public static RuntimeException wrapRuntimeCamelException(final Throwable e) {
        try {
            @SuppressWarnings({ "unchecked", "rawtypes" })
            final Class<? extends RuntimeException> clazz = (Class) Class.forName("org.apache.camel.RuntimeException");
